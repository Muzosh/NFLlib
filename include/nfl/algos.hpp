...
namespace nfl
{
    ...
    namespace ops
    {
        ...
        struct ntt_loop_body<simd::serial, poly, T>
        {
            ...
            ntt_loop_body(value_type const p) { _p = p; }

            inline void operator()(value_type *x0, value_type *x1,
                                   value_type const *winvtab,
                                   value_type const *wtab) const
            {
                value_type u0 = *x0;
                value_type u1 = *x1;
                ...
                value_type q = ((greater_value_type)t1 * (*winvtab)) >>
