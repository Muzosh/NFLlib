...
namespace nfl
{
    ...
    template <>
    struct common_mode<simd::sse, simd::serial>
    {
        using type = simd::serial;
    };
    template <>
    struct common_mode<simd::serial, simd::sse>
    {
        using type = simd::serial;
    };
    ...
    namespace ops
    {
        ...
        {
            assert_vec_values<simd::sse, Integer>(sse_v, [p](Integer const v)
                                                  { return v < p; });
        }
...
#endif
            static size_t
            run(value_type *x, const value_type *&wtab, const value_type *&winvtab, const value_type p)
            {
