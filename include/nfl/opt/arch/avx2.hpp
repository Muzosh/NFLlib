...
namespace nfl
{
    ...
    template <>
    struct common_mode<simd::avx2, simd::serial>
    {
        using type = simd::serial;
    };
    template <>
    struct common_mode<simd::avx2, simd::sse>
    {
        using type = simd::sse;
    };
    template <>
    struct common_mode<simd::sse, simd::avx2>
    {
        using type = simd::sse;
    };
    template <>
    struct common_mode<simd::serial, simd::avx2>
    {
        using type = simd::serial;
    };
    ...
    namespace ops
    {
        ...
        {
            assert_vec_values<simd::avx2, Integer>(avx_v, [p](Integer const v)
                                                   { return v < p; });
        }
...
#endif
            static size_t
            run(value_type *x, const value_type *&wtab,
...
#endif
            __m128i
            operator()(__m128i const sse_x, __m128i const sse_y, __m128i const sse_yprime, size_t const cm) const
            {
